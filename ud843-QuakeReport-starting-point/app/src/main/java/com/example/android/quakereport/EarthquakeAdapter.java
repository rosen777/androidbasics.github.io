...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Using the DecimalFormat class to format the magnitude so only one decimal place is shown
        String formattedMagnitude = formatMagnitude(currentEarthquake.getMagnitude());

        // Find the TextView in the list_item.xml layout with the ID magnitude
        TextView magnitudeTextView = (TextView) listItemView.findViewById(R.id.magnitude);

        // Get the magnitude from the current Earthquake
        ...
        // String original location from the Earthquake object
        ...
        // Get the primary location from the current Earthquake object and
        // set this text on the primary location TextView
        primaryLocationTextView.setText(primaryLocation);

        // Find the TextView from the list_item.xml layout with the id location offset
        TextView locationOffsetTextView = (TextView) listItemView.findViewById(R.id.location_offset);

        //  Get the offset location from the current Earthquake object
        //  and set this text on the offset location TextView
    ...
    /**
     * Get the color of the magnitude circle of the earthquake
     */
