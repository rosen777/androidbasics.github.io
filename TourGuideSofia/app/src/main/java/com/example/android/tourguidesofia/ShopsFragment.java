...
public class ShopsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        places.add(new Place("Boulevard Vitosha", "24 hours", R.drawable.boulevard_vitosha));
        places.add(new Place("Paradise Center", "10AM – 10PM", R.drawable.paradise_center));
        places.add(new Place("Serdika Center", "10AM – 10PM", R.drawable.serdika_center));
        places.add(new Place("Sofia Ring Mall", "10AM – 10PM", R.drawable.sofia_ring_mall));
